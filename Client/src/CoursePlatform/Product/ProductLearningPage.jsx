...
const ProductLearningPage = () => {
  ...
  console.log(`ProductLearningPage initialized with skillType: ${skillType}, topic: ${topic}`);
  ...
  const goToNextTopic = async () => {
    ...
    try {
      ...
      setTimeout(() => {
        setLoading(false);
        console.log(skillType, currentIndex, topics.length);
        ...
        content && (
          <>
            <div className="content-header">
              <h1>{content.title || topics.find(t => t.id === topic)?.title || 'Product Training'}</h1>
            </div>
