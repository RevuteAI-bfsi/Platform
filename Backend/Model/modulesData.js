const modulesData = [
  {
    ...
    subItems: [
      ...
      },
      {
        ...
        content: {
          quiz: [
            { question: "Explain the basic parts of speech.", questionType: "openEnded", expectedAnswer: "answer" },
            { question: "What is the importance of verb tenses?", questionType: "openEnded", expectedAnswer: "answer" },
            { question: "Describe proper sentence structure.", questionType: "openEnded", expectedAnswer: "answer" },
            { question: "Why is professional vocabulary important?", questionType: "openEnded", expectedAnswer: "answer" },
            { question: "How do punctuation rules affect meaning?", questionType: "openEnded", expectedAnswer: "answer" },
            { question: "What is a compound sentence?", questionType: "openEnded", expectedAnswer: "answer" },
            { question: "Define the term 'subject-verb agreement'.",questionType: "openEnded", expectedAnswer: "answer" },
            { question: "How do you identify a prepositional phrase?",questionType: "openEnded", expectedAnswer: "answer" },
            { question: "What role do adjectives play in a sentence?",questionType: "openEnded", expectedAnswer: "answer" },
            { question: "Explain the concept of active vs. passive voice.",questionType: "openEnded", expectedAnswer: "answer" }
          ]
        }
      },
      {
